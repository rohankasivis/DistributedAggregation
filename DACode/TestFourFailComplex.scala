...
object TestFourFailComplex extends App
{
  ...
  // set up the connection map over here
  neighbors = neighbors + (node_one -> Set(root_node, node_three))
  neighbors = neighbors + (node_two -> Set(root_node, node_two, node_four))
  neighbors = neighbors + (node_three -> Set(node_one, node_two, node_five))
  neighbors = neighbors + (node_four -> Set(node_one, node_two, node_three, node_six))
  neighbors = neighbors + (node_five -> Set(node_two, node_three, node_four, node_seven))
  neighbors = neighbors + (node_six -> Set(node_two, node_three, node_four, node_five, node_eight, node_nine))
  neighbors = neighbors + (node_seven -> Set(node_one, node_three, node_four, node_five, node_six))
  neighbors = neighbors + (node_eight -> Set(node_one, node_three, node_four, node_five, node_six, node_seven, node_ten))
  neighbors = neighbors + (node_nine -> Set(node_two, node_three, node_four, node_five, node_six, node_seven))
  neighbors = neighbors + (node_ten -> Set(node_two, node_three, node_four, node_five, node_six, node_eight))
  ...
  neighbors.get(node_seven) match {
    case Some(s) => s.foreach { n => node_seven ! Fail(n) }
    case None => ()
  }
  //system stop node_one
  neighbors = neighbors - node_seven

  neighbors.get(node_nine) match {
    case Some(s) => s.foreach { n => node_nine ! Fail(n) }
    case None => ()
  }
  //system stop node_one
  neighbors = neighbors - node_nine
