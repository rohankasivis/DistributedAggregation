...
object TestDropMultiple extends App
{
  ...
  // test with multiple drop statements
  node_one ! Drop(node_three, 10)
  node_two ! Drop(node_four, 15)
  node_three ! Drop(node_five, 14)
  node_four ! Drop(node_six, 10)
  node_five ! Drop(node_seven, 11)
  node_six ! Drop(node_eight, 11)
  node_seven ! Drop(node_four, 5)
  node_eight ! Drop(node_one, 10)
  node_nine ! Drop(node_four, 7)
  node_ten ! Drop(node_six, 10)
