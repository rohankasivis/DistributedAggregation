/*
* Local test with fail in between. This is used to make sure that the other nodes
* are able to aggregate properly despite one failed node.
* */
...
object TestOneFailSimple extends App
{
