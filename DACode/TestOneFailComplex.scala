/*
* This is used to test that a single node failing works with the nodes involved
* in testmultiplelocal.
* */
...
object TestOneFailComplex extends App
{
  ...
  val future_twotwo = node_two ? New(node_two)
  val result_twotwo = Await.ready(future_twotwo, timeout.duration)
